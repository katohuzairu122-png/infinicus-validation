# BUILD-18 SPECIFICATION — AUTHENTICATION AND AUTHORIZATION

- **Build ID:** BUILD-18
- **Layer:** AUTH
- **Dependency:** BUILD-17
- **Specification status:** FROZEN
- **Implementation status:** BLOCKED until BUILD-17 is completed
- **Purpose:** Deliver the Authentication and Authorization production-readiness capability without silently implementing later builds.

## 1. Entry gate

Before implementation:

1. verify `BUILD-17` is completed;
...
- session lifecycle;
- tenant/workspace/business membership;
...
```text
BUILD-18: blocked -> ready after BUILD-17 completion
BUILD-18: ready -> in_progress -> completed
```
