...
# that grant-app-role.sh then grants schema access to. Mirrors what
# every prior environment in this repo has needed done by hand; here
# it's automated so a fresh OCI VM doesn't need a manual psql step.
set -euo pipefail
