...
function create(x={}){
  ...
  return r.success({
    procurementPurchaseManagementEnginePolicyId:x.procurementPurchaseManagementEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.procurementPurchaseManagementEnginePolicyModel=Object.freeze({create});
})(window);
