...
function create(x={}){
  ...
  return r.success({
    incidentExceptionEscalationEnginePolicyId:x.incidentExceptionEscalationEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.incidentExceptionEscalationEnginePolicyModel=Object.freeze({create});
})(window);
