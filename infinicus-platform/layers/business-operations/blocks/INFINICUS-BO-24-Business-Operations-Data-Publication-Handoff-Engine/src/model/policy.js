...
function create(x={}){
  ...
  return r.success({
    businessOperationsDataPublicationEnginePolicyId:x.businessOperationsDataPublicationEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.businessOperationsDataPublicationEnginePolicyModel=Object.freeze({create});
})(window);
