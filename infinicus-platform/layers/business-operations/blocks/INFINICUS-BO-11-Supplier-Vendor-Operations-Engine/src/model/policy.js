...
function create(x={}){
  ...
  return r.success({
    supplierVendorOperationsEnginePolicyId:x.supplierVendorOperationsEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.supplierVendorOperationsEnginePolicyModel=Object.freeze({create});
})(window);
