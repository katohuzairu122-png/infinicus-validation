...
function create(x={}){
  ...
  return r.success({
    fulfilmentDeliveryLogisticsEnginePolicyId:x.fulfilmentDeliveryLogisticsEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.fulfilmentDeliveryLogisticsEnginePolicyModel=Object.freeze({create});
})(window);
