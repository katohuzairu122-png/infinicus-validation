...
function create(x={}){
  ...
  return r.success({
    warehouseStorageOperationsEnginePolicyId:x.warehouseStorageOperationsEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.warehouseStorageOperationsEnginePolicyModel=Object.freeze({create});
})(window);
