...
function create(x={}){
  ...
  return r.success({
    operationalPerformanceEventPublicationEnginePolicyId:x.operationalPerformanceEventPublicationEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.operationalPerformanceEventPublicationEnginePolicyModel=Object.freeze({create});
})(window);
