...
function create(x={}){
  ...
  return r.success({
    orderTransactionManagementEnginePolicyId:x.orderTransactionManagementEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.orderTransactionManagementEnginePolicyModel=Object.freeze({create});
})(window);
