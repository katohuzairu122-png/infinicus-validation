...
function create(x={}){
  ...
  return r.success({
    schedulingCapacityResourceAllocationEnginePolicyId:x.schedulingCapacityResourceAllocationEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.schedulingCapacityResourceAllocationEnginePolicyModel=Object.freeze({create});
})(window);
