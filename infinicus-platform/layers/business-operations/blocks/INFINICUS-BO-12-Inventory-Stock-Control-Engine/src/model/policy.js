...
function create(x={}){
  ...
  return r.success({
    inventoryStockControlEnginePolicyId:x.inventoryStockControlEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.inventoryStockControlEnginePolicyModel=Object.freeze({create});
})(window);
