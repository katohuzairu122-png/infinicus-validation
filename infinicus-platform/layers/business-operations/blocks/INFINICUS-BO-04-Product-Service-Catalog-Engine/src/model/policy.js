...
function create(x={}){
  ...
  return r.success({
    productServiceCatalogEnginePolicyId:x.productServiceCatalogEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.productServiceCatalogEnginePolicyModel=Object.freeze({create});
})(window);
