...
function create(x={}){
  ...
  return r.success({
    complianceControlOperationalRiskEnginePolicyId:x.complianceControlOperationalRiskEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.complianceControlOperationalRiskEnginePolicyModel=Object.freeze({create});
})(window);
