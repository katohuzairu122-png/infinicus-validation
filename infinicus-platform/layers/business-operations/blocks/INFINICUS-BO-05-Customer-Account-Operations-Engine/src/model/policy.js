...
function create(x={}){
  ...
  return r.success({
    customerAccountOperationsEnginePolicyId:x.customerAccountOperationsEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.customerAccountOperationsEnginePolicyModel=Object.freeze({create});
})(window);
