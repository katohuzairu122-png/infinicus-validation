...
function create(x={}){
  ...
  return r.success({
    assetEquipmentMaintenanceEnginePolicyId:x.assetEquipmentMaintenanceEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.assetEquipmentMaintenanceEnginePolicyModel=Object.freeze({create});
})(window);
