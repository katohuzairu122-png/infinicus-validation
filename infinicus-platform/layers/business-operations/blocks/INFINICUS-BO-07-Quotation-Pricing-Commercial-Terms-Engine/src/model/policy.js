...
function create(x={}){
  ...
  return r.success({
    quotationPricingCommercialTermsEnginePolicyId:x.quotationPricingCommercialTermsEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.quotationPricingCommercialTermsEnginePolicyModel=Object.freeze({create});
})(window);
