...
function create(x={}){
  ...
  return r.success({
    organizationDepartmentResponsibilityRegistryEnginePolicyId:x.organizationDepartmentResponsibilityRegistryEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.organizationDepartmentResponsibilityRegistryEnginePolicyModel=Object.freeze({create});
})(window);
