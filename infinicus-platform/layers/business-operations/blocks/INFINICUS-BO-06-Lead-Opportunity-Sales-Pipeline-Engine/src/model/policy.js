...
function create(x={}){
  ...
  return r.success({
    leadOpportunitySalesPipelineEnginePolicyId:x.leadOpportunitySalesPipelineEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.leadOpportunitySalesPipelineEnginePolicyModel=Object.freeze({create});
})(window);
