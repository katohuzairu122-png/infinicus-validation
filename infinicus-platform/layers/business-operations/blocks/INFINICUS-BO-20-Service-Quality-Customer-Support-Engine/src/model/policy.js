...
function create(x={}){
  ...
  return r.success({
    serviceQualityCustomerSupportEnginePolicyId:x.serviceQualityCustomerSupportEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.serviceQualityCustomerSupportEnginePolicyModel=Object.freeze({create});
})(window);
