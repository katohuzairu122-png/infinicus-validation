...
function create(x={}){
  ...
  return r.success({
    expenseCostOperationalFinanceEnginePolicyId:x.expenseCostOperationalFinanceEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.expenseCostOperationalFinanceEnginePolicyModel=Object.freeze({create});
})(window);
