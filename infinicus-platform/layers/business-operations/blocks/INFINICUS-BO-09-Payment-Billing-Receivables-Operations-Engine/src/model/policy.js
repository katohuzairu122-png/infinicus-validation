...
function create(x={}){
  ...
  return r.success({
    paymentBillingReceivablesEnginePolicyId:x.paymentBillingReceivablesEnginePolicyId||r.createId("bo_policy"),
    name:String(x.name),
    code:String(x.code),
...
g.INFINICUS.BO.paymentBillingReceivablesEnginePolicyModel=Object.freeze({create});
})(window);
